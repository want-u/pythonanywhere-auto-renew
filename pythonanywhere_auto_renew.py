...
print("DEBUG: 开始执行")
usernames = os.getenv("PYTHONANYWHERE_USERNAME")
passwords = os.getenv("PYTHONANYWHERE_PASSWORD")

for u in zip(usernames.split(","), passwords.split(",")):
    ...
    # 4、进行网站续期
    url = (
        "https://www.pythonanywhere.com/user/%s/webapps/%s.pythonanywhere.com/extend"
        % (
            username,
            username,
        )
